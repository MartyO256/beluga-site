import{s as v,n as c}from"../chunks/scheduler.BRW4IjsR.js";import{S as d,i as y,s as i,H as h,e as u,k as w,d as l,f as m,o as k,c as g,l as x,m as f,g as r}from"../chunks/index.yRNBcVz4.js";const M=`<div class="documentation">
...
`;function A(b){let n,t,e,s,o="Download the code";return{c(){n=i(),t=new h(!1),e=i(),s=u("a"),s.textContent=o,this.h()},l(a){w("svelte-dso6ga",document.head).forEach(l),n=m(a),t=k(a,!1),e=m(a),s=g(a,"A",{class:!0,href:!0,"data-svelte-h":!0}),x(s)!=="svelte-qyw7n1"&&(s.textContent=o),this.h()},h(){document.title="Weak head normalization for simply-typed lambda calculus",t.a=e,f(s,"class","btn btn-lg btn-primary mb-4"),f(s,"href","https://github.com/Beluga-lang/Beluga/blob/master/examples/literate_beluga/2Advanced/Weak_Normalization.bel")},m(a,p){r(a,n,p),t.m(M,a,p),r(a,e,p),r(a,s,p)},p:c,i:c,o:c,d(a){a&&(l(n),t.d(),l(e),l(s))}}}class S extends d{constructor(n){super(),y(this,n,null,A,v,{})}}export{S as component};
