import{s as y,n as p}from"../chunks/scheduler.BRW4IjsR.js";import{S as m,i as b,s as i,H as u,e as v,k as g,d as c,f as d,o as w,c as x,l as k,m as h,g as l}from"../chunks/index.yRNBcVz4.js";const T=`<div class="documentation">
...
`;function _(f){let e,s,n,t,r="Download the code";return{c(){e=i(),s=new u(!1),n=i(),t=v("a"),t.textContent=r,this.h()},l(a){g("svelte-1yb712t",document.head).forEach(c),e=d(a),s=w(a,!1),n=d(a),t=x(a,"A",{class:!0,href:!0,"data-svelte-h":!0}),k(t)!=="svelte-1i8g73s"&&(t.textContent=r),this.h()},h(){document.title="Type Uniqueness for the Simply-typed Lambda-calculus",s.a=n,h(t,"class","btn btn-lg btn-primary mb-4"),h(t,"href","https://github.com/Beluga-lang/Beluga/blob/master/examples/literate_beluga/0Beginner/Type_Uniqueness.bel")},m(a,o){l(a,e,o),s.m(T,a,o),l(a,n,o),l(a,t,o)},p,i:p,o:p,d(a){a&&(c(e),s.d(),c(n),c(t))}}}class F extends m{constructor(e){super(),b(this,e,null,_,y,{})}}export{F as component};
